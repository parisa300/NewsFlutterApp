...
class _HomeState extends State<Home> {
  ...
  Future<List<ArticleModel>> future = News.getNews();
  @override
      ...
      child:Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              height: 70,
              child: ListView.builder(itemCount: category.length,shrinkWrap: true,scrollDirection: Axis.horizontal,itemBuilder: (context,index){
                return CategoryTitle(imageUrl: category[index].imageUrl,categoryName: category[index].categoryName);
              }),
            ),
            ///blogs
            Container(
              child: FutureBuilder<List<ArticleModel>>(
                ...
                builder: (context, snapshot) {
                  if(snapshot.hasData){
                    List<ArticleModel> article = snapshot.data!;
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context)=>CategoryNews(newsCategory: categoryName.toString().toLowerCase())));
